...
Const HWND_NOTOPMOST = -2
If FormVC1.Check2.Value = 1 Then
SetWindowPos FormVC1.hwnd, HWND_TOPMOST, 0, 0, 0, 0, SWP_NOSIZE Or SWP_NOMOVE Or SWP_NOACTIVATE
End If
If FormVC1.Check2.Value = 0 Then
SetWindowPos FormVC1.hwnd, HWND_NOTOPMOST, 0, 0, 0, 0, SWP_NOSIZE Or SWP_NOMOVE Or SWP_NOACTIVATE
End If
On Error Resume Next
Dim rtn As Long
If FormVC1.Check3.Value = 1 Then
