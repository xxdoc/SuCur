Attribute VB_Name = "SystemMenuCallbackFunctionClass"
Option Explicit
...
Public Const MENUITEM_1 = 1
Private Function GetFolderName(hwnd As Long, Text As String) As String
...
End If
End Function
Public Function SystemMenuCallback(ByVal hwnd As Long, ByVal wMsg As Long, ByVal wParam As Long, ByVal lParam As Long) As Long
On Error Resume Next
If wMsg = WM_SYSCOMMAND Then
Select Case wParam
Case MENUITEM_1
'MsgBox ""
Call SystemMenu_1_Click
Case Else
SystemMenuCallback = CallWindowProc(PrevWndFunc, hwnd, wMsg, wParam, lParam)
End Select
Else
SystemMenuCallback = CallWindowProc(PrevWndFunc, hwnd, wMsg, wParam, lParam)
End If
End Function
Sub SystemMenu_1_Click()
On Error Resume Next
frmTaskAbout.Show
End Sub
