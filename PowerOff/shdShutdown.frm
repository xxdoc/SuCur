...
Begin VB.Form shdShutdown 
   ...
   Begin VB.Image Image1 
      Height          =   480
      Left            =   210
      Picture         =   "shdShutdown.frx":1108
      Top             =   135
      Width           =   480
   End
   Begin VB.Label Label1 
      BackStyle       =   0  'Transparent
      Caption         =   "    系统即将关机,请保存正在进行的工作和活动应用程序的数据,所有尚未保存的数据都可能丢失."
      BeginProperty Font 
         Name            =   "宋体"
         Size            =   10.5
         Charset         =   134
