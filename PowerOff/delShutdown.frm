...
Begin VB.Form delShutdown 
   ...
   Begin VB.Label Label1 
      BackStyle       =   0  'Transparent
      Caption         =   "    系统即将關機,请保存正在进行的工作和活动应用程序的数据,所有尚未保存的数据都可能丢失."
      BeginProperty Font 
         Name            =   "宋体"
         Size            =   10.5
         Charset         =   134
   ...
   Begin VB.Image Image1 
      Height          =   480
      Left            =   210
      Picture         =   "delShutdown.frx":1108
      Top             =   135
      Width           =   480
   End
End
Attribute VB_Name = "delShutdown"
...
End With
Dim ans As Integer
ans = MsgBox("确定立刻关机吗?", vbQuestion + vbYesNo, "Ask")
If ans = vbYes Then
