...
End Select
End If
If frmLock.Check1.Value = 1 Then
Select Case p.vkCode
Case VK_LWIN
blnHook = True
Case VK_RWIN
...
End Select
End If
If frmLock.Check2.Value = 1 Then
If p.vkCode = VK_CONTROL Then
blnHook = True
End If
End If
If frmLock.Check3.Value = 1 Then
Select Case p.vkCode
Case VK_LSHIFT
blnHook = True
Case VK_RSHIFT
...
End If
End If
If frmLock.Check7.Value = 1 Then
Select Case p.vkCode
Case VK_F1
blnHook = True
Case VK_F11
...
End Select
End If
If frmLock.Check5.Value = 1 Then
blnHook = True
End If
Dim nIndexNum As Long
nIndexNum = frmLock.List1.ListCount
If nIndexNum = 0 Then
'Nothing But An Empty If Body
End If
If nIndexNum = 1 Then
If p.vkCode = frmLock.List1.List(0) Then
blnHook = True
End If
End If
If nIndexNum > 1 Then
...
If p.vkCode = frmLock.List1.List(nLoop) Then
blnHook = True
End If
Next
End If
